...
for word in word_list:
    ...
    for char in word:
        ...
        if match:
            ...
            matched_number = word_to_number.get(matched_word)
            print('matched', substring, matched_number)
            first_digit = matched_number
            break
    ...
    for i in range(len(word) - 1, -1, -1):
        ...
        if match:
            ...
            matched_number = word_to_number.get(matched_word)
            print('matched', substring, matched_number)
            last_digit = matched_number
            break

    num = int(first_digit + last_digit)
    print(num)
    print(word, '-', first_digit, last_digit, num)
    sum = sum + num
